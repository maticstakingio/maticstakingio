...
namespace Core.Application.Helpers
{
    public class PropertyByName<T>
    {
        ...
        public PropertyByName(string propertyName, Func<T, object> func = null,
            ...
            bool isHyperlinkAppend = false,
            string hyperlinkAppendUrl = "")
        {
            ...
            IsHyperlinkAppend = isHyperlinkAppend;
            HyperlinkAppendUrl = hyperlinkAppendUrl;
        ...
        public long LongValue
        {
            get
            {
                if (PropertyValue == null || !long.TryParse(PropertyValue.ToString(), out var rez))
                    return default(long);
                return rez;
            }
        }
        ...
        public bool IsHyperlinkAppend { get; set; }

        public string HyperlinkAppendUrl { get; set; }
